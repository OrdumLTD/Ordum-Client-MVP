...
export const ProfileContextProvider = ({ children }: Props) => {
  const [profileData, setProfileData] =
    useState<createProfileData>(defaultProfileData);
...
const defaultFetchedProfile: FetchedProfile = {
  ...
  fetchedStatus: false,
  setProfile: (value: TeamApplicantProfile) => {
    return;
  },
  setFetchedStatus: (v: boolean) => {
    return;
  },
};
...
export const FetchedProfileContextProvider = ({ children }: Props) => {
  ...
  return (
    <FetchedProfileContext.Provider
      value={{
        profileData,
        fetchedStatus,
        setProfile,
...
export const useIndividualProfileContext = () =>
  useContext(IndividualProfileContext);
...
const defaultFetchedIndividualProfile: FetchedIndividualProfile = {
  ...
  fetchedStatus: false,
  setProfile: (value: IndividualProfile) => {
    return;
  },
  setFetchedStatus: (v: boolean) => {
    return;
...
export const FetchedIndividualProfileContextProvider = ({
  ...
  return (
    <FetchedIndividualProfileContext.Provider
      value={{
        profileData,
        fetchedStatus,
        setProfile,
...
export const useFetchedIndividualProfileContext = () =>
  useContext(FetchedIndividualProfileContext);
...
export const ApplicantNameNIdContextProvider = ({ children }: Props) => {
  ...
  return (
    <ApplicantNameNIdContext.Provider
      value={{
        data: profileData,
...
export const useAppicantNameNIdContext = () =>
  useContext(ApplicantNameNIdContext);
...
const defaultIndividualNameNId: IndividualNameNId = {
  data: [],
  setIndividualNameNId: (v: NameNId) => {
    return;
  },
};
...
export const useIndividualNameNIdContext = () =>
  useContext(IndividualNameNIdContext);
