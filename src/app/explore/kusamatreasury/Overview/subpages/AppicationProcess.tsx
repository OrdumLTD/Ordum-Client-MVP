    ...
    <div className=" mx-10 md:ml-16 md:mr-32 md:text-xl font-space-grotesk flex flex-col ">
      <div>
        <div className="flex mb-5">
          <div className="border rounded-full border-black border-2 px-5 py-3 -ml-4">
            1
          </div>
        ...
        <div className="ml-14">
          ...
          <Image className="mt-8" src={bigSpender} alt="Big spender graph" />
        </div>
        ...
        <div className="mt-16 ml-14 mb-20 flex flex-col gap-4">
          <Button primeColor>Join Element and get to know the community</Button>
