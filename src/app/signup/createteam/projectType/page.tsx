  ...
  return (
    ...
    >
      ...
      >
        ...
        <option value="All">What are you creating? Chooce a category</option>
        DeFi Privacy Infrastructure Network Changes Art Media Gaming Events
        Education NFTs Translations Other
