      ...
      <div className="flex-flex flex-col justify-start mb-2">
        ...
        <div>
          ...
          <div className="mt-2 w-full flex gap-2">
            <input
              className="basis-3/4 text-gray-500 text-xs md:text-sm bg-white border border-black rounded pl-2  md:py-2 focus:outline-none"
            ...
            <select
              className=" 
            text-gray-500 text-xs md:text-sm bg-white border border-black rounded pl-2  md:py-2 focus:outline-none
            "
              // defaultValue={""}
              value={skillLevel}
            ...
            >
              ...
              <option value="Senieor ">Senieor </option>
            </select>
          </div>
        </div>

        <div className="mt-5">
          <label className="font-semibold">Describe Skill</label>
          <textarea
            className="mt-2 text-gray-500 mt-2 w-full bg-inherit text-sm placeholder:font-italitc placeholder:text-xs placeholder-gray-300 border border-gray-500
             rounded py-2 pl-2 pr-4 focus:outline-none resize-none
              min-h-[8rem]"
            placeholder="Description of skill expertise and experience. Eg. I started working with Figma 2 years ago and used it consistently in my freelance projects. "
            value={description}
